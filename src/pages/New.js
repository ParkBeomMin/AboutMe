...
export default class New {
    ...
    async render() {
        ...
        $button.addEventListener('click', async () => {
            ...
            window.navigator.clipboard.writeText(`${window.location.host}/#/about/${id}`);
            Swal.fire({
                html: '나의 새싹이 생성되었습니다.<br>클립보드에 복사된 링크로 친구들에게 공유해보세요!',
            }).then((v) => {
        ...
        $info.innerHTML = '친구들의 관심을 모아 새싹을 자라나게 해주세요!<br>새싹 -> 중간 -> 트리 형태로 자라납니다<br>나무의 형태, 색상은 모두 랜덤으로 생성됩니다.';
